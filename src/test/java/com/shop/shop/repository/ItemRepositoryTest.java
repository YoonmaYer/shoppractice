...
import static com.shop.shop.entity.QItem.item;
...
class ItemRepositoryTest {
   ...
   // @Test
    ...
    public void querydslTest2() {
        ...
        // String을 ItemSellStatus 열거형으로 변환하여 비교
        if(StringUtils.isNotBlank(itemSellStat) && ItemSellStatus.valueOf(itemSellStat) == ItemSellStatus.SELL){
